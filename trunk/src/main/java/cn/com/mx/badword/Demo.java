...
public class Demo {
	...
	/**
	 * 测试 敏感词库类型
	 * isStrict为true则调用严格敏感词库
	 * @throws IOException 
	 */
	public static void test05() throws IOException{
		String s ="马化腾傻逼儿子";
		String variety ="dasdas";
		Date start = new Date();
		Set<String> set = SensitiveWord.initMap(variety).getSensitiveWord(s, 2,variety);
		Date over= new Date();
		System.out.println(set);
		long res = over.getTime() - start.getTime();
